...
SECRET_KEY = 'django-insecure-d)_0r9h6j4cm96t^@_324@l%9rhz80e#j(54zf#!qyyse7_vzk'
...
LOGIN_REDIRECT_URL = '/'  # Redirect to directory page after login

# Add this to redirect to home after logout
LOGOUT_REDIRECT_URL = '/'